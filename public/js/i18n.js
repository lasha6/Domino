...
(function (global) {
  ...
  const EN = {
    ...
    "გრძელი, მოკლე · დამკა": "Long, short · damka",
    ...
    "თავის წესი (გრძელი).": "The head rule (long).",
    "ერთ სვლაზე თავიდან მხოლოდ ერთი ქვა ჩამოდის. პირველ სვლაზე გამონაკლისია 6-6, 4-4 და 3-3 — მაშინ ორი შეიძლება.": "Only one checker leaves the head in a turn. The opening roll is the exception: 6-6, 4-4 and 3-3 let a second one out.",
    "ექვსი ზედიზედ (გრძელი).": "Six in a row (long).",
