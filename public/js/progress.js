...
(function (root, factory) {
  ...
  const SHOP = [
    ...
    { id: "table-emerald", kind: "table", title: "ზურმუხტი", price: 3500, currency: "coins",
      vars: { "--wood-hi": "#2f7d5e", "--wood": "#17513c", "--wood-lo": "#0a2a1e",
              "--baize-lit": "#39b083", "--baize": "#126b4c", "--baize-mid": "#157a56", "--baize-deep": "#083a29", "--baize-edge": "#052419" } },
    { id: "table-sand", kind: "table", title: "ქვიშისფერი", price: 4000, currency: "coins",
      vars: { "--wood-hi": "#b08a4e", "--wood": "#7a5c2e", "--wood-lo": "#433014",
              "--baize-lit": "#c2a56a", "--baize": "#8a7040", "--baize-mid": "#9c7f4a", "--baize-deep": "#544325", "--baize-edge": "#332916" } },
    ...
    { id: "table-plum", kind: "table", title: "ღვინისფერი", price: 30, currency: "gems",
      vars: { "--wood-hi": "#7a4a86", "--wood": "#4a2a56", "--wood-lo": "#26132c",
              "--baize-lit": "#8f5aa0", "--baize": "#4d2a5c", "--baize-mid": "#5c3370", "--baize-deep": "#2b1533", "--baize-edge": "#1a0d1f" } },
    // tiles
    ...
    { id: "tiles-marble", kind: "tiles", title: "მარმარილო", price: 2200, currency: "coins",
      vars: { "--bone-hi": "#ffffff", "--bone": "#eef1f4", "--bone-lo": "#d3dae1", "--bone-edge": "#9aa7b4", "--pip": "#2a3a4a" } },
    ...
    { id: "tiles-gold", kind: "tiles", title: "ოქროსფერი", price: 35, currency: "gems",
      vars: { "--bone-hi": "#fff3cf", "--bone": "#f0d99a", "--bone-lo": "#d9bd72", "--bone-edge": "#a8873c", "--pip": "#4a3208" } },
  ];
